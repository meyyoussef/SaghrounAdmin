    ...
    <div class="container-xl">
        <div class="table-responsive">
                ...
                <table class="table table-striped table-hover table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $enfant->gender }}</td>
                            <td>{{ $enfant->age }}</td>
                            <td>{{ $enfant->allergies ?: 'Aucune' }}</td>
                            <td>{{ $enfant->conditions ?: 'Aucune' }}</td>
                            <td>{{ $enfant->frais}}</td>
                            <td>{{ $enfant->phone }}</td>
                            <td>{{ $enfant->email }}</td>
                            <td>
            ...
            <i class="material-icons">&#xE417;</i>
                ...
                <div class="clearfix">
                    <div class="hint-text">Show of  <b>{{ $enfants->count() }}</b> infants</div>
                </div>
            </div>
        </div>
    </div>
