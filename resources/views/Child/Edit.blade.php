...
<script>
   ...
   function displayCurrentDate() {
    ...
    <div class="container">
        ...
        @endif
        <form id="update-form" method="POST" action="{{ route('update-child', $child->id) }}">
            @csrf
            @method('PUT')
            ...
            <input type="text" name="phone" value="{{ $child->phone }}">
            
 
            
            <label for="email">Email:</label>
            <input type="email" name="email" value="{{ $child->email }}">
            
            <label for="dateofbirth">Date of Birth:</label>
            <input type="date" name="dateofbirth" value="{{ $child->dateofbirth }}">
            ...
            <input type="text" name="allergies" value="{{ $child->allergies }}">
            
            <label for="conditions">Conditions:</label>
            <input type="text" name="conditions" value="{{ $child->conditions }}">
            
            <label for="message">Message:</label>
            <textarea name="message">{{ $child->message }}</textarea>
            
            <label for="username">Username:</label>
            <input type="text" name="username" value="{{ $child->username }}">
            
           
            
            <label for="frais">Frais:</label>
            <input type="text" name="frais" value="{{ $child->frais }}">
