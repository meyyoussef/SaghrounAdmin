...
<div class="Tableau">
        ...
        <div class="table-responsive">
            <div class="table-wrapper">
                ...
                <table class="table table-striped table-hover table-bordered">
                    ...
                    <tr>
                        <td>{{ $educatrice->firstname }}</td>
                        <td>{{ $educatrice->lastname }}</td>
                        <td>{{ $educatrice->Level }}</td>
                        <td>{{ $educatrice->salary }}</td>
                        <td>{{ $educatrice->phone }}</td>
                        <td>{{ $educatrice->email }}</td>
                        <td>
                           
                       <!-- Bouton de  consulter profile-->
                       <a href="{{ route('profile.educatrice', ['id' => $educatrice->id]) }}" class="view" title="View" data-toggle="tooltip">
            <i class="material-icons">&#xE417;</i>
        </a>
    ...
    <i class="material-icons">&#xE254;</i>
                            ...
                            <a href="#" class="delete" title="Delete" data-toggle="tooltip" onclick="confirmDelete('{{ $educatrice->id }}', '{{ $educatrice->lastname }}')">
                                <i class="material-icons">&#xE872;</i>
                            </a>
                        </td>
                    </tr>
               ...
               @foreach($educatrices as $educatrice)
                <form id="delete-form-{{ $educatrice->id }}" action="{{ route('delete.educatrice', $educatrice->id) }}" method="POST" style="display: none;">
                    @csrf
                    @method('DELETE')
                </form>
                @endforeach
                ...
                <div class="clearfix">
                    <div class="hint-text">Show of <b>{{ $educatrices->count() }}</b> teachers</div>
                </div>
            </div>  
        </div>
    </div>
 ...
 document.addEventListener('DOMContentLoaded', function() {
    ...
    function confirmDelete(id, nomComplet) {
        ...
        confirmationDialog.innerHTML = `
            <p>Are you sure you want to delete  '${nomComplet}' ?</p>
            <button class="confirm" onclick="deleteEducator(${id})">Confirm</button>
    ...
    function deleteEducator(id) {
        ...
        showToast("L'éducatrice a été supprimée avec succès.");
    }
