            ...
            style="background:url(assets/images/big) no-repeat center center;">
                ...
                <div class="col-lg-5 col-md-7 bg-white">
                    <div class="p-3">
                        ...
                        <h2 class="mt-3 text-center">Chef's informations</h2>
                        <form class="mt-4" action="{{ route('ajouter-chef') }}" method="POST">
                        @csrf               
                            
                            <div class="row">
                            <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" type="text" placeholder="Enter the NIC of the chef" name="nic"  oninput="validateNic()">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" type="text" placeholder="Enter the name of the chef" name="firstname"  oninput="validateNom()">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" type="text" placeholder="Enter the lastname of the chef" name="lastname" oninput="validatePrenom()">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" type="text"  placeholder="Enter the phone number of the chef" name="phone" oninput="validateTelephone()">
                                        <span id="telephoneError" class="text-danger"></span>    
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" type="text"  placeholder="Enter the address  of the chef" name="address" oninput="validateAddress()">
                                        <span id="address" class="text-danger"></span>    
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" type="email" placeholder="Enter the email of the chef" name="email" oninput="validateEmail()">
                                        <span id="EmailError" class="text-danger"></span>    
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control datepicker" type="text" placeholder="Enter the date of birth  of the chef"  name="dateofbirth">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" type="text" placeholder="Enter the gender of the chef" name="gender">
                                      
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" type="text" placeholder="Enter the social status of the chef" name="status">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" type="text" placeholder="Enter the chef's specialty" name="type_degree" oninput="validateSpecialite()">
                                        <span id="SpecialiteError" class="text-danger"></span>  
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" type="text" placeholder="Enter the chef's spoken languages" name="languages" >
