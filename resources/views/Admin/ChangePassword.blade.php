...
<body>
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
            ...
            <div class="col-lg-5 col-md-7 bg-white">
                <div class="p-3">
                    ...
                    <h2 class="mt-3 text-center">Change your password.</h2>
                    <form class="mt-4" method="POST" id="logout-form" action="">
    ...
    <div class="col-lg-12">
        <div class="form-group">
            ...
            <input id="password" class="form-control" type="password" placeholder="Entre your new password" name="password">
            @error('password')
    ...
    <div class="col-lg-12">
        <div class="form-group">
            ...
            <input id="password" class="form-control" type="password" placeholder="Confirm your new password" name="Confirmpassword">
            @error('password')
                <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
                            ...
                            <div class="col-lg-12 text-center">
                                <button type="submit" class="btn btn-block btn-dark">Reset</button>
                            </div>
